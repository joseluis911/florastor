//<![CDATA[
  ...
  var html_title;
   ...
   function searchLocationsNear(center) {
     ...
     var searchUrl = 'https://florastor.ca/wp-content/themes/florastor-ca-v3/backend/genxml.php?lat=' + center.lat() + '&lng=' + center.lng() + '&radius=' + radius;
    ...
    function createMarker(latlng, store_name, address, city, state, zipcode) {
      ...
      var icon = {
          url: "/wp-content/themes/florastor-ca-v3/images/marker" + labels[labelIndex++ % labels.length] + ".png",
...
//ADD SWITCH HERE
      switch(store_name){
        ...
        case 'Duane Reade':
            ...
            break;
        case 'Mark Drugs':
            html_title = "<div id='markdrugs'></div>";
            list_logo = "<span class='pull-right list-logo' id='markdrugs'></span>";
            break;
        case 'Dougherty\'s Pharmacy':
            html_title = "<div id='doughertys'></div>";
            list_logo = "<span class='pull-right list-logo' id='doughertys'></span>";
            break;
        case 'Bed Bath & Beyond':
            html_title = "<div id='bedbath'></div>";
            list_logo = "<span class='pull-right list-logo' id='bedbath'></span>";
            break;
        case 'Wegmans':
            html_title = "<div id='wegmans'></div>";
            list_logo = "<span class='pull-right list-logo' id='wegmans'></span>";
            break;
        default:
